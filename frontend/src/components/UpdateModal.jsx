        ...
        <form className="flex flex-col gap-2 2xl:gap-10 w-full relative" onSubmit={handleSubmit(handleNoteUpdation)}>
          <div className="flex flex-col gap-1 text-lg 2xl:text-2xl">
            <div className="w-full">
              <input type="text" name="title" placeholder="Enter title" className="px-4 py-2 rounded-lg w-full" {...register('title', { maxLength: 15 })} defaultValue={updatingNote.title} />
            ...
            <div className="w-full">
              <input type="text" placeholder="Default:'General'" className="px-4 py-2 rounded-lg w-full" {...register('tag', { maxLength: 8 })} defaultValue={updatingNote.tag} />
