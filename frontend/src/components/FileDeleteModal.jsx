        ...
        <Modal onClose={() => setOpenFileDeleteModal(false)} width={'w-full max-w-[700px]'}>
            <div className='w-[90%] mx-auto pt-5'>
                ...
                <div className='text-sm md:text-xl flex flex-wrap-reverse mt-10 items-center justify-center gap-y-4 gap-x-5 sm:w-[300px] mx-auto'>
                    <button className='rounded-full flex items-center justify-center gap-2 mx-auto px-5 py-2 font-bold border border-green-400 hover:bg-green-500 hover:text-white transition-all ease-in-out duration-500' onClick={handleCancelation}><MdCancel size={25} />Cancel</button>
                    <button className='flex items-center justify-center gap-2 mx-auto border border-red-600 px-5 py-2 rounded-full  font-bold hover:bg-red-500 hover:text-white transition-all ease-in-out duration-500' onClick={handleFileDeleteConfirmation}>
                        <MdDelete size={25} />
                        Delete
                    </button>
                </div>
