...
const Modal = ({ children, onClose, height, maxWidth, width }) => {
  return (
    <div className="fixed top-0 left-0 right-0 bottom-0 z-20 bg-gray-200 bg-opacity-75 flex items-center justify-center px-5">
      <div className={`bg-slate-100 shadow-2xl p-[20px] rounded-xl relative z-30 ${width} md:w-[${maxWidth}] ${height} overflow-y-auto`}>
        {children}
