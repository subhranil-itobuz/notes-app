  ...
  return (
    <Modal onClose={() => setOpenPasswordUpdateModal(false)} height={'max-h-[800px]'} width={'w-[95%] md:w-[700px]'}>
      ...
      <form className='flex flex-col gap-2 w-full  text-base md:text-xl' onSubmit={handleSubmit(handlePasswordUpdation)}>
        ...
        <div>
          <input type="text" name='oldPassword' placeholder='old password' className='border border-slate-600 rounded-md w-full p-2 text-xl focus:outline-none' {...register('oldPassword', { required: true, minLength: 5 })} />
        ...
        <div>
          <input type="text" name='newPassword' placeholder='new password' className='border border-slate-600 rounded-md w-full p-2 text-xl focus:outline-none' {...register('newPassword', { required: true, minLength: 5 })} />
        ...
        <div>
          <input type="text" name='confirmNewPassword' placeholder='confirm new password' className='border border-slate-600 rounded-md w-full p-2 text-xl focus:outline-none' {...register('confirmNewPassword', { required: true, minLength: 5 })} />
