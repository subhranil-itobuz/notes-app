...
const UserNameChangeModal = ({ userName }) => {
  ...
  return (
    <Modal onClose={() => setOpenUserNameUpdateModal(false)} height={'max-h-[550px]'} width={'w-[95%] md:w-[700px]'}>
      ...
      <form className='flex flex-col gap-3 w-full text-xl' onSubmit={handleSubmit(handleUserNameUpdation)}>
        ...
        <div>
          <input type="text" name='newUserName' placeholder='xxxx11' defaultValue={userName} className='border border-slate-600 rounded-md w-full mt-2 p-2 text-xl focus:outline-none' {...register('newUserName', { required: true, minLength: 4, maxLength: 15 })} />
